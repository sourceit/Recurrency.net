...
namespace RecurrencyTests
{
    ...
    public class BaseRecurrencyTests
    {
        ...
        {
            DailyRecurrency daily = new DailyRecurrency("D2011051220110522000000X000050");
        ...
        {
            var daily = new DailyRecurrency(new DateTime(2011, 10, 7), new DateTime(2011, 12, 25));
            Assert.AreEqual("2011100720111225000000", daily.GetInitialPattern());
        }

        [Test]
        public void GetInitialPattern_Occurences()
        {
            var daily = new DailyRecurrency(new DateTime(2011, 10, 7), 52);
            Assert.AreEqual("2011100700000000000052", daily.GetInitialPattern());
        }
    }
}
